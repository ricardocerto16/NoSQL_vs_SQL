...
CREATE (actor:Actor { Id: line.actor_id, First_Name: line.first_name, Last_Name: line.last_name, Last_Update: line.last_update})

CREATE (cit:City{ Id: line3.city_id, City_Name: line3.city, Country_ID: line3.country_id, Last_Update: line3.last_update})